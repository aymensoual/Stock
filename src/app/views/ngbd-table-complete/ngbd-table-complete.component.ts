...
export class NgbdTableCompleteComponent implements OnInit {
  ...
  edit(id){
    let componant={ClientsComponent:"Ecran Clients",
    CategorysComponent:"Ecran Categories",
    SuppliersComponent:"Ecran Fournisseur",
    StoresComponent:"Ecran Magasins",
    InputComponent:"Ecran Achats",
    OutputComponent:"Ecran Ventes"}
